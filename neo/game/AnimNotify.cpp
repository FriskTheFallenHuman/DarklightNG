...
Game-side handling for animation frame commands.  The animation data,
blending, model definitions and animator implementation live in neo/anim;
this file is the explicit callback boundary for gameplay behavior.
