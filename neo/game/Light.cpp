...
void idGameEdit::ParseSpawnArgsToRenderLight( const idDict *args, renderLight_t *renderLight ) {
	...
	// disagree about which lights are baked.  "bake" remains an explicit opt-in
	// or opt-out for unusual maps.
	const bool isMapLight = !idStr::Icmp( args->GetString( "classname", "" ), "light" );
