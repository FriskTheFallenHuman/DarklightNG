...
idCVar r_skipAtmosphere( "r_skipAtmosphere", "0", CVAR_RENDERER | CVAR_BOOL, "disable ETQW-style atmospheric fog and sky scattering" );
idCVar r_atmosScale( "r_atmosScale", "1", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_FLOAT, "scale atmospheric extinction", 0.0f, 8.0f );
...
idCVar r_skipBink( "r_skipBink", "0", CVAR_RENDERER | CVAR_BOOL, "skip Bink decoding" );
...
idCVar r_showSurfaces( "r_showSurfaces", "0", CVAR_RENDERER | CVAR_BOOL, "report surface/light counts" );
...
void R_VidRestart_f( const idCmdArgs &args ) {
	...
	// free current world-derived data and vertex caches
	R_FreeDerivedData();
	...
	// regenerate world references invalidated by the restart
...
void R_InitCommands( void ) {
	...
	cmdSystem->AddCommand( "regenerateWorld", R_RegenerateWorld_f, CMD_FL_RENDERER, "regenerates world references" );
