...
====================
*/
idRenderModel *idRenderModelLiquid::InstantiateDynamicModel( const idRenderEntity *ent, const struct viewDef_s *view, idRenderModel *cachedModel ) {
...
====================
*/
idBounds idRenderModelLiquid::Bounds(const idRenderEntity *ent) const {
