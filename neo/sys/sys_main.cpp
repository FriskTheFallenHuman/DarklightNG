...
int WINAPI WinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow ) {
	...
	if ( SDL_Init( SDL_INIT_VIDEO | SDL_INIT_EVENTS | SDL_INIT_TIMER ) != 0 ) {
		...
		Conbuf_AppendText( "SDL2 initialization failed: " );
		Conbuf_AppendText( sdlError );
		Conbuf_AppendText( "\n" );
		MessageBoxA( NULL, sdlError, GAME_NAME " SDL2 initialization failed", MB_OK | MB_ICONERROR );
		Sys_DestroyConsole();
		return 1;
	}
